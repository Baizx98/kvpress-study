...
OUTPUT_DIR="${OUTPUT_DIR:-./results_prefill_sweep_10pct}"
...
# RULER: long-context synthetic retrieval
run_dataset_grid "ruler" "4096"

# LongBench: representative QA-style task
run_dataset_grid "longbench" "triviaqa"

# Needle in a Haystack: use multiple insertion depths to expand the single base sample
